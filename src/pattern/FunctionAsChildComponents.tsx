...
export class FunctionAsChildComponents extends React.Component<any,any>{
    ...
    public render(){
        return  <div>
                    <ContainerComponents>{this.renderProps}</ContainerComponents>
                </div>
    }
}
...
type CCP = {
    children:(props:CCP,state:CCS)=>JSX.Element
}
